...
function WorkList({ title, description, link, techUsed = [], img, githubRepo, text, index }) {
  ...
  return (
    <div
      ...
      className="p-6 w-full bg-gray-100 dark:bg-[grey]/10 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 gap-4 lg:flex"
    >
      ...
      <div className="mt-4 lg:mt-0 lg:w-[50%]">
        ...
        <p className="mt-2 text-base text-gray-600 dark:text-gray-500">{description}</p>
