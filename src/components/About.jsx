...
function About() {
  ...
  return (
    ...
    <h1 className="about-text1 text-n-2 dark:text-n-1/70 font-semibold text-3xl md:text-4xl text-center">
      I love making cool things and solving complex problems for people — like you.
    </h1>
    <h1 className="about-text2 text-n-2 dark:text-n-1/70 font-semibold text-3xl md:text-4xl text-center">
