export const works = [
  ...
  // { id: 2, title: 'Project 2', img: '', description: 'Description of Project 2', text: 'Details about Project 2', link: 'https://example.com/project2', techUsed: ['Tech1', 'Tech2'] , githubRepo: 'https://github.com/user/photoruum-join-form'},
  // { id: 3, title: 'Project 3', img: '', description: 'Description of Project 3', text: 'Details about Project 3', link: 'https://example.com/project3', techUsed: ['Tech1', 'Tech2'] },
